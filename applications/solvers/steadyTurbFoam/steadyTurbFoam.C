...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
    ...
    const word method = mesh.solutionDict().subDict("SOLVER").lookupOrDefault<word>("method", "LUSGS");
    const scalar CFL  = mesh.solutionDict().subDict("SOLVER").lookupOrDefault<scalar>("CFL", 1.0);
